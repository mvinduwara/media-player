...
public class PlayerBar extends HBox {
    ...
    // ── Left: cover + track info + favourite ──────────
    ...
    private HBox buildLeftSection() {
        ...
        // Favourite button — uses .btn-favourite from player-bar.css
    ...
    private HBox buildCenterSection() {
        ...
        // Prev and Next use .btn-step for the slightly bolder hover scale
        ...
        // Play/pause uses its own .btn-play circle style
    ...
    private void bindToService() {
        ...
        // Seek slider tracks current position
        ...
        // Volume slider ↔ service (bidirectional)
    ...
    private void updateShuffleBtn() {
        ...
        shuffleBtn.getStyleClass().removeAll("active");
    ...
    private void updateRepeatBtn() {
        ...
        repeatBtn.getStyleClass().removeAll("active");
        switch (mode) {
            case "ALL" -> {
    ...
    private void updateMuteBtn() {
        ...
        muteBtn.getStyleClass().removeAll("muted");
    ...
    private void updateFavouriteBtn(boolean fav) {
        favouriteBtn.getStyleClass().removeAll("active");
